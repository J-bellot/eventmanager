 ...
 */
final class Version20231002204440 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE event CHANGE begin_at begin_at DATE NOT NULL, CHANGE end_at end_at DATE NOT NULL');
    }
}
